...
#
#     PHX_SERVER=true bin/whatsapp_saas start
#
...
if config_env() == :prod do
  ...
  config :whatsapp_saas, WhatsappSaas.Repo,
    ...
    timeout: String.to_integer(System.get_env("QUERY_TIMEOUT") || "15000"),
    connect_timeout: String.to_integer(System.get_env("CONNECT_TIMEOUT") || "5000")
  ...
  config :whatsapp_saas, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
